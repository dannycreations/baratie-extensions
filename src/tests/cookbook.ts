...
function runCookbookTest(input: InputType<unknown>, spices: CookbookTestSpice): ResultType<string> | null {
...
const COOKBOOK_TEST_DEFINITION: IngredientDefinition<CookbookTestSpice, unknown, string> = {
